...
#define XLPhotoBrowserDebug 0
//是否开启断言调试模式
#define IsOpenAssertDebug 0
...
// 图片保存成功提示文字
#define XLPhotoBrowserSaveImageSuccessText myLocalize(@"_YM_SAVE_SUCCESS_", @"保存成功");
// 图片保存失败提示文字
#define XLPhotoBrowserSaveImageFailText myLocalize(@"_YM_SAVE_FAIL_", @"保存失败");
// 网络图片加载失败的提示文字
#define XLPhotoBrowserLoadNetworkImageFail myLocalize(@"_YM_PICTURE_LOAD_FAIL_", @"图片加载失败");
#define XLPhotoBrowserLoadingImageText myLocalize(@"_YM_PICTURE_IN_LOADING_", @"图片加载中");

// browser背景颜色
#define XLPhotoBrowserBackgrounColor [UIColor colorWithRed:0 green:0 blue:0 alpha:0.75]
// browser 图片间的margin
